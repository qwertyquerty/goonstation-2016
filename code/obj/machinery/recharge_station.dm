			...
			if (istype(occupant,/mob/living/silicon/robot/))
				...
				if (RC.part_arm_r)
					if (RC.part_arm_r.ropart_get_damage_percentage(0) > 0)
						dmgalerts++
						if (RC.part_arm_r.slot == "arm_both") dat += "<b>Arms Unit Damaged</b> ([RC.part_arm_r.ropart_get_damage_percentage(1)]%, [RC.part_arm_r.ropart_get_damage_percentage(2)]%)<BR>"
						else dat += "<b>Right Arm Unit Damaged</b> ([RC.part_arm_r.ropart_get_damage_percentage(1)]%, [RC.part_arm_r.ropart_get_damage_percentage(2)]%)<BR>"
				else
					dmgalerts++
				...
				if (RC.part_arm_l)
					if (RC.part_arm_l.ropart_get_damage_percentage(0) > 0)
						dmgalerts++
						if (RC.part_arm_l.slot != "arm_both") dat += "<b>Left Arm Unit Damaged</b> ([RC.part_arm_l.ropart_get_damage_percentage(1)]%, [RC.part_arm_l.ropart_get_damage_percentage(2)]%)<BR>"
				else
					dmgalerts++
				...
				if (RC.part_leg_r)
					if (RC.part_leg_r.ropart_get_damage_percentage(0) > 0)
						dmgalerts++
						if (RC.part_leg_r.slot == "leg_both") dat += "<b>Legs Unit Damaged</b> ([RC.part_leg_r.ropart_get_damage_percentage(1)]%, [RC.part_leg_r.ropart_get_damage_percentage(2)]%)<BR>"
						else dat += "<b>Right Leg Unit Damaged</b> ([RC.part_leg_r.ropart_get_damage_percentage(1)]%, [RC.part_leg_r.ropart_get_damage_percentage(2)]%)<BR>"
				else
					dmgalerts++
				...
				if (RC.part_leg_l)
					if (RC.part_leg_l.ropart_get_damage_percentage(0) > 0)
						dmgalerts++
						if (RC.part_leg_l.slot != "arm_both") dat += "<b>Left Leg Unit Damaged</b> ([RC.part_leg_l.ropart_get_damage_percentage(1)]%, [RC.part_leg_l.ropart_get_damage_percentage(2)]%)<BR>"
				else
					dmgalerts++
